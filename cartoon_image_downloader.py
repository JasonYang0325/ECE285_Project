...
PATH_TO_SAFEBOORU_ALL_DATA_CSV = './dataset/all_data.csv'
PATH_TO_STORE_DOWNLOADED_CARTOON_IMAGES = './dataset/yourname/'
CARTOON_IMAGES_ZIPFILE_NAME = './dataset/yourname'
